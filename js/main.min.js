...
/* harmony import */ var _node_modules_gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../node_modules/gsap/dist/gsap */ "../node_modules/gsap/dist/gsap.js");
/* harmony import */ var _node_modules_gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_node_modules_gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _node_modules_gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../node_modules/gsap/ScrollTrigger */ "../node_modules/gsap/ScrollTrigger.js");
/* harmony import */ var _node_modules_locomotive_scroll_dist_locomotive_scroll__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../node_modules/locomotive-scroll/dist/locomotive-scroll */ "../node_modules/locomotive-scroll/dist/locomotive-scroll.js");
/* harmony import */ var _node_modules_locomotive_scroll_dist_locomotive_scroll__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_node_modules_locomotive_scroll_dist_locomotive_scroll__WEBPACK_IMPORTED_MODULE_3__);




document.addEventListener("DOMContentLoaded", function () {
  var mainSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](".swiper-container", {
    effect: "coverflow",
    grabCursor: true,
    centeredSlides: true,
    slidesPerView: "auto",
  ...
  var mainSliderFade = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](".swiper-container1", {
    effect: "fade",
    fadeEffect: {
      crossFade: true
    },
...
var dropdown = document.querySelectorAll(".main-nav__item--with-dropdown");
dropdown.forEach(function (element) {
  return element.addEventListener("click", function (event) {
    // event.preventDefault();
    // event.stopPropagation();
    document.querySelectorAll(".main-nav__item--with-dropdown").forEach(function (element) {
      element.classList.remove("main-nav__item--open");
    });
    element.classList.add("main-nav__item--open");
    var innerLists = element.querySelector("ul");

    if (innerLists) {
      if (!innerLists.classList.contains("main-nav__sublist--open")) {
        document.querySelector("ul").querySelectorAll("ul").forEach(function (elm) {
...
if (document.querySelector("[data-scroll-container]")) {
  var scroller = new _node_modules_locomotive_scroll_dist_locomotive_scroll__WEBPACK_IMPORTED_MODULE_3___default.a({
    el: document.querySelector("[data-scroll-container]"),
    smooth: true
  });
  _node_modules_gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].registerPlugin(_node_modules_gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__["ScrollTrigger"]);
  scroller.on("scroll", _node_modules_gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__["ScrollTrigger"].update);
  _node_modules_gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__["ScrollTrigger"].scrollerProxy(".container", {
  ...
  _node_modules_gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__["ScrollTrigger"].create({
    trigger: ".section__image-mask",
    scroller: ".container",
    start: "top+=30% 50%",
    end: "bottom-=40% 50%",
    animation: _node_modules_gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].to(".section__image-mask", {
      backgroundSize: "120%"
    }),
    scrub: 5 // markers: true

  });
  _node_modules_gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__["ScrollTrigger"].addEventListener("refresh", function () {
    return scroller.update();
  });
  _node_modules_gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__["ScrollTrigger"].refresh();
}
