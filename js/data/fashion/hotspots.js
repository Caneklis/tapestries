  ...
  me.hotspots = [
    {
      ...
      title: "Костюм",
      description: `
      <a class="ssb__gallery-popup-link  ssd__main-img" href="images/fashion/fashion-full-1.jpg"><img src="images/fashion/fashion-thumb-1.jpg"  data-caption="Описание для картинки во всплывающем окне"></a>
        <div class="ssb__full-text">
          ...
          <a class="ssb__before-after  ssb__gallery-popup-link" href="images/fashion/fashion-full.jpg" data-caption="Описание для картинки во всплывающем окне">
            <!-- Изображение до -->
              <img src="images/fashion/fashion-1.jpg" />
            <!-- Изображение после -->
              <img src="images/fashion/fashion-1b.jpg" />
          </a>
